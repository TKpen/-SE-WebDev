...
// same core calculation as your original component
...
export default function GradeCal({ onDetailsOpenChange }) {
  ...
  // helper to update the currently selected course
  ...
  function handleAddRow(newRowCategoryId) {
    updateActiveCourse((course) => {
      const newRow = {
        ...
        name: "",
        grade: "",
        weightClassId: newRowCategoryId || (course.weights[0]?.id ?? "homework"),
        editing: true,
      };
      return {
        ...course,
  ...
  // for "New row category" select for the active course
          ...
          return (
            ...
            >
              ...
              <div className="flex justify-between items-center text-[10px] text-gray-400">
                <span>{course.result != null ? `${course.result.toFixed(1)}%` : "No grade yet"}</span>
              </div>
            ...
            <div className="h-full flex flex-col md:flex-row gap-4">
              ...
              {activeCourse && (
                <div className="flex-1 bg-gray-900 border border-gray-700 rounded-lg p-4 flex flex-col">
                  ...
                  {/* Rows grouped by category (still acts like assignment type folders) */}
                          ...
                          {catRows.map((row) => (
                            ...
                            >
                              ...
                              <input
                                ...
                                className={`border px-3 py-2 rounded bg-gray-900 w-full text-sm text-gray-100 focus:outline-none 
